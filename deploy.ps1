...
Write-Host ""
$RAILWAY_DOMAIN = Read-Host "Enter your Railway domain (e.g., lifelink-prod.railway.app)"
...
Write-Host "2. Add:"
Write-Host ""
Write-Host "REACT_APP_API_BASE_URL=$RAILWAY_URL/api"
...
Write-Host ""
$VERCEL_DOMAIN = Read-Host "Enter your Vercel domain (e.g., lifelink.vercel.app)"
...
try {
    $response = Invoke-RestMethod -Uri "$RAILWAY_URL/health" -ErrorAction Stop
    Write-Host $response -ForegroundColor Green
} catch {
    Write-Host "Check backend status in Railway dashboard" -ForegroundColor Yellow
}
...
Write-Host "===================="
Write-Host "Backend (Railway):  $RAILWAY_URL"
Write-Host "Frontend (Vercel):  $VERCEL_URL"
Write-Host ""
